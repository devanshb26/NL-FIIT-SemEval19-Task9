...
for model_name in ensemble_models:
    ...
    df=pd.DataFrame({'reviews':valid_data[ : ,1],'predictions':predicted,'labels':labels}) 
    ...
    print('| Macro Precision: {} | Micro Precision: {} |'.format(precision_score(labels, predicted, average='macro'), precision_score(labels, predicted, average='micro')))
    print('| Macro Recall: {} | Micro Recall: {} |'.format(recall_score(labels, predicted, average='macro'), recall_score(labels, predicted, average='micro')))
    print('| Macro F1: {} | Micro F1: {} | Binary F1: {} |'.format(f1_score(labels, predicted, average='macro'), f1_score(labels, predicted, average='micro'), f1_score(labels, predicted)))
    print('--------------------------------------------------------------------------------------------------------------------')
    ...
    save_predictions_with_probabilities(name='submissions/' + model_name + '_full', predictions=predicted, original_data=test_data, labels=labels, probabilities=model_predictions)
...
#     df=pd.DataFrame({'predictions':predicted,'labels':labels})
    ...
    print('| Macro Precision: {} | Micro Precision: {} |'.format(precision_score(labels_B, predicted_B, average='macro'), precision_score(labels_B, predicted_B, average='micro')))
    print('| Macro Recall: {} | Micro Recall: {} |'.format(recall_score(labels_B, predicted_B, average='macro'), recall_score(labels_B, predicted_B, average='micro')))
    print('| Macro F1: {} | Micro F1: {} | Binary F1: {} |'.format(f1_score(labels_B, predicted_B, average='macro'), f1_score(labels_B, predicted_B, average='micro'), f1_score(labels_B, predicted_B)))
    print('--------------------------------------------------------------------------------------------------------------------')
